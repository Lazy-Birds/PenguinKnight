...
void draw_menu(Game_Output *out, Entity *player) {
	...
	Rectangle2 con_bar = r2_bounds(v2(28, 308), v2(240, 18), v2_zero, v2_one);
	Rectangle2 rig_bar = r2_bounds(v2(28, 380), v2(240, 18), v2_zero, v2_one);
	Rectangle2 str_bar = r2_bounds(v2(28, 452), v2(240, 18), v2_zero, v2_one);
	Rectangle2 dex_bar = r2_bounds(v2(28, 524), v2(240, 18), v2_zero, v2_one);
	Rectangle2 men_bar = r2_bounds(v2(28, 596), v2(240, 18), v2_zero, v2_one);
